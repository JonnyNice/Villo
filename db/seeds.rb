...
puts "Seeding users..."
u1 = User.create(username:"Caitlin", email: 'Caitlin@gmail.com', password: "1234")
u2 = User.create(username:"Lizzie", email: 'lizzie@yahoo.com', password:"ilovechicken")
u3 = User.create(username:"Tom G", email: 'Tom@hotmail.com', password:"dragonslayer")
u4 = User.create(username: "Morgan", email: 'Morgan@gmail.com',password:"master")
u5 = User.create(username:"Danny", email: 'Danny@gmail.com', password:"420")
u6 = User.create(username: "Peter N", email: 'Peter@gmail.com', password:"sub")
u7 = User.create(username: "Amanda", email: 'amanda@gmail.com', password:"hello")
u8 = User.create(username:"Nick", email: 'nick@gmail.com', password:"morgan")
